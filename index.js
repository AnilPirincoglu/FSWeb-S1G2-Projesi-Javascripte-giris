...
function bilgisayarinSecimi() {
  ...
  switch(Math.floor(Math.random()*3)){
    case 0: return bilgisayarSecimi="Taş";
    case 1: return bilgisayarSecimi="Kağıt";
    case 2: return bilgisayarSecimi="Makas";
  }
}
...
function cocukSarkisi(sayi) {
  const metin=" küçük maymun yatakta zıplamış, biri düşüp başını çarpmış, Anne doktoru aramış, Doktor çok kızmış: Bir daha yatakta zıplamak yok!";
  return sayi + metin;
}
